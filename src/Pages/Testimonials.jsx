  ...
  return (
    <div className="text-[#000000]  flex flex-col h-[500px] md:flex-row md:h-[413px]  ">
      ...
      <div className="relative   md:w-[50%] h-[206px] md:h-[413px]">
        <img src={girl} alt="Girl with Bag " className=" h-[206px] md:h-[413px] w-full" />
        {/* Gradient overlay */}
      ...
      <div className="bg-[#CAEE00] md:w-[50%] flex flex-col gap-5  px-2 md:px-0 md:pl-10">
        ...
        <div className="flex flex-col gap-4" >
          <p className="underline leading-[29.9px] text-[26px]"> Athul Surendran</p>
          <p className="underline leading-[21.85px] text-[19px]"> UI/UX Designer </p>
        </div>
